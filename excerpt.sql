...
INSERT INTO excerpt(text, page_number, book_uid, chapter, section)
VALUES('What I have to say could indeed have significance, especially for everyone who deals with children or has any relation to them ... The art is that of constantly being present, and yet not being present, so that the child may be allowed to develop himself, and at the same time one still has a clear view of the development. The art is to leave the child to himselfin the very highest degree and on the greatest possible scale, and to express this apparent relinquishing in such a way that, unnoticed, one is aware of everything.', 126, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');
...
'fcebabd3-c23f-4564-bb61-8ddfd14065cb', null, 'Anxiety as Saving Through Faith'); 
