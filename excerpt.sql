...
INSERT INTO excerpts (text, page_number, book_uid, chapter, section)
...
INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('To say that someone with a mind for intrigue ought to be a diplomat or a detective, that someone with a mimic talent for the comical ought to be an actor, and that someone with no talent at all ought to be a stoker in the courthouse is an altogether meaningless view of life, or it is rather no view at all ...', 105, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety Defined Dialectically as Guilt', 'Anxiety as the Consequence of that Sin which is Absence of the Consciousness of Sin');     
...
INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('However, just as wishing is the most paltry of all solo performances, so being sympathetic in the sense in which the word is usually used is the most paltry of all social virtuosities and aptitudes. Sympathy, so far from being a good to the sufferer, is rather a means of protecting one''s own egotism. Not daring in the deeper sense to think about such things, one saves oneself by sympathy. Only when the sympathetic person in his compassion relates himself to the sufferer in such a way that he in the strictest sense understands that it is his own case that is in question, only when he knows how to identify himself with the sufferer in such a way that when he fights for an explanation he is fighting for himself, renouncing all thoughtlessness, softness, and cowardice- only then does the sympathy acquire significance, and only then does it perhaps find a meaning ...', 120, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('The person who is not developed ethically to the extent that he would find comfort and relief if, even when he suffered the most, someone had the courage to say to him, "This is not fate, it is guilt," that he would find comfort and relief when this was told to him sincerely and earnestly-such a person is not in a true sense ethically developed, because the ethical individuality fears nothing so much as fate and esthetic rigmarole that in the cloak of compassion would trick him out of the jewel, which is freedom.', 121, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('In our courageous age, we dare not tell a patient that he is about to die, we dare not call the pastor lest he die from shock, and we dare not tell the patient that a few days ago a man died from the same disease. The patient would be isolated. Sympathy would inquire about his condition. The physician would promise to issue a report as soon as possible, along with a tabulated statistical survey in order to determine the average. And when one has arrived at the average, everything is explained.', 122, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('If an inquisitor has the required physical strength and the spiritual elasticity to endure without moving a muscle, to endure even for sixteen hours, he will succeed, and the confession will burst forth involuntarily. A man with a bad conscience cannot endure silence. If placed in solitary confinement, he becomes apathetic. But this silence while the judge is present, while the clerks are ready to inscribe everything in the protocol, this silence is the most penetrating and acute questioning. It is the most frightful torture and yet permissible.', 125, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('About this I could write a whole book, although I have not been, according to the custom and the established convention among the observers of our day, in Paris and London, as if by such visits one could learn something great, more than chatter and the wisdom of traveling salesmen. If an observer will only pay attention to himself, he will have enough with five men, five women, and ten children for the discovery of all possible states of the human soul.', 126, 
'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('What I have to say could indeed have significance, especially for everyone who deals with children or has any relation to them ... The art is that of constantly being present, and yet not being present, so that the child may be allowed to develop himself, and at the same time one still has a clear view of the development. The art is to leave the child to himself in the very highest degree and on the greatest possible scale, and to express this apparent relinquishing in such a way that, unnoticed, one is aware of everything.', 126, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES(' Even though the word were terrible, even though it were a Shakespeare, a Byron, or a Shelley who breaks the silence, the word always retains its redeeming power, because all the despair and all the horror of evil expressed in a word are not as terrible as silence.', 131, 
'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('Viewed intellectually, the content of freedom is truth, and truth makes man free. For this reason, truth is the work of freedom, and in such a way that freedom constantly brings forth truth ... what I am speaking about is very plain and simple, namely, that truth is for the particular individual only as he himself produces it in action. If the truth is for the individual in any other way, or if he prevents the truth from being for him in that way, we have a phenomenon of the demonic.', 138, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('It is not my desire to use big words in speaking about the age as a whole, but he who has observed the present generation can hardly deny that the discrepancy in it and the reason for its anxiety and unrest is this, that in one direction truth increases in scope and in quantity, and partly also in abstract clarity, while in the opposite direction certainty constantly declines. What extraordinary metaphysical and logical efforts have been put forth in our time to produce a new, exhaustive, and absolutely correct proof, combining all earlier proofs, of the immortality of the soul; and strangely enough, while this is taking place, certitude declines.', 139, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single 
Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('To understand a speech is one thing, and to understand what it refers to, namely, the personal, is something else; for a man to understand what he himself says is one thing, and to understand himself in what is said is something else.', 142, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('The most concrete content that consciousness can have is consciousness of itself, of the individual himself-not the pure self-consciousness, but the self-consciousness that is so concrete that no author, not even the one with the greatest power of description, has ever been able to describe a single such self-consciousness, although every single human being is such a one. This self-consciousness is not contemplation, for he who believes this has not understood himself, because he sees that meanwhile he himself is in the process of becoming and consequently cannot be something completed for contemplation. This self-consciousness, therefore, is action ...', 143, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual');

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('Pride begins through an activity, cowardice through a passivity; in all other respects they are identical ...  Pride is a profound cowardice, for it is cowardly enough not to be willing to understand what pride truly is. As soon as this understanding is forced upon it, it is cowardly, disintegrates with a bang, and bursts like a bubble. Cowardice is a profound pride, because it is cowardly enough not to be willing to understand even the claims of a misunderstood pride, and it manifests its pride by shrinking, as well as by taking into account the fact that it has never suffered a defeat. Therefore it is proud of pride''s negative expression, namely, that it has never suffered a loss. It has also been the case in life that a very proud individuality was so cowardly as never to venture anything, cowardly enough to be as insignificant as possible, precisely in order to save his own pride.', 145, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('To the extent of my knowledge, I am not aware that there exists a single definition of earnestness. If this were true, it would please me, not because I love the modern fluent and confluent thinking that has abolished the definition, but because in relation to existential concepts it always indicates a greater discretion to abstain from definitions, because a person can hardly be inclined to apprehend essentially in the form of definition what must be understood differently, what he himself has understood differently, what he has loved in an entirely different way, and which in the form of definition easily becomes something else, something foreign to him. Whoever loves can hardly find joy and satisfaction, not to mention growth, in preoccupation with a definition of what love properly is.', 147, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('In its historical development, the originality of disposition marks precisely the eternal in earnestness, for which reason earnestness can never become habit ... When the originality in earnestness is acquired and preserved, then there is succession and repetition, but as soon as originality is lacking in repetition, there is habit. The earnest person is earnest precisely through the originality with which he returns in repetition ... To make everything as concrete as possible, I shall use an example. Every Sunday, a clergyman must recite the prescribed common prayer, and every Sunday he baptizes several children. Now let him be enthusiastic etc. The fire burns out, he will stir and move people etc., but at one time more and at another time less. Earnestness alone is capable of returning regularly every Sun-
day with the same originality to the same thing.', 149, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('In life there is not infrequently talk about earnestness. Someone is in earnest about the national debt, another about the categories, and a third about a performance at the theater, etc. Irony discovers that this is the case, and with that it has enough to occupy itself, because everyone who becomes earnest at the wrong place is eo ipso comical, even though an equally comical, travestied contemporary age and the opinion of the age may be exceedingly earnest about it. Therefore, there is no measuring rod more accurate for determining the essential worth of an individuality than what is learned through the individual''s own loquacity or by cunningly extracting from him the secret: What has made him earnest in life? For one may be born with disposition, but no one is born with earnestness.', 150, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin or Anxiety as the Consequence of Sin in the Single Individual'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('If the eternal is posited, the present becomes something different from what a person wants it to be. He fears this, and thus he is in anxiety about the good ... So they preach the moment, and just as the road to hell is paved with good intentions, so eternity is best annihilated by mere moments. But why do people rush around in such a terrible haste? If there is no eternity, the moment is just as long as if there were.', 152, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', 'Anxiety About the Good (The Demonic)', 'Anxiety of Sin 
or Anxiety as the Consequence of Sin in the Single Individual'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('However, I will say that this is an adventure that every human being must go through-to learn to be anxious in order that he may not perish either by never having been in anxiety or by succumbing in anxiety. Whoever has learned to be anxious in the right way has learned the ultimate.', 155, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', null, 'Anxiety as Saving Through Faith'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('Whoever is educated by anxiety is educated by possibility, and only he who is educated by possibility is educated according to his infinitude. Therefore possibility is the weightiest of all categories. It is true that we often hear the opposite stated, that possibility is so light, whereas actuality is so heavy. But from whom does one hear such words? From wretched men who never knew what possibility is, and who, when actuality had shown that they were not good for anything and never would be, mendaciously revived a possibility that was very beautiful and very enchanting, while the foundation of this possibility was at the most a little youthful giddiness, of which they ought rather to be ashamed. Therefore this possibility that is said to be so light is commonly regarded as the possibility of happiness, fortune, etc. But this is not possibility. It is rather a mendacious invention that human depravity has dressed up so as to have a reason for complaining of life and Governance and a pretext for becoming self-important. No, in possibility all things are equally possible, and whoever has truly been brought up by possibility has grasped the terrible as well as the joyful.', 156,'fcebabd3-c23f-4564-bb61-8ddfd14065cb', null, 'Anxiety as Saving Through Faith'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('So when such a person graduates from the school of possibility, and he knows better than a child knows his ABC''s that he can demand absolutely nothing of life and that the terrible, perdition, and annihilation live next door to every man, and when he has thoroughly learned that every anxiety about which he was anxious came upon him in the next moment-he will give actuality another explanation, he will praise actuality, and even when it rests heavily upon him, he will remember that it nevertheless is far, far lighter than possibility was. Only in this way can possibility be educative, because finiteness and the finite relations in which every individual is assigned a place, whether they be small, or everyday, or world-historical, educate only finitely, and a person can always persuade them, always coax something else out of them, always bargain, always escape from them tolerably well, always keep himself a little on the outside, always prevent himself from absolutely learning something from them ...', 157, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', null, 'Anxiety as Saving Through Faith'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('When one or another extraordinary event occurs in life, when a world-historical hero gathers heroes about him and performs deeds of valor, when a crisis occurs and everything gains significance, then men want to have a part in it, because all of this is educative. Possibly so. But there is a simpler way in which one may become more thoroughly educated. Take the pupil of possibility, place him in the middle of the Jutland heath, where no event takes place or where the greatest event is a grouse flying up noisily, and he will experience everything more perfectly, more accurately, more thoroughly than the man who received the applause on the stage of world-history if that man was not educated by possibility.', 159, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', null, 'Anxiety as Saving Through Faith'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('Even in the most trifling matters, as soon as the individuality wants to make a cunning turn that is merely cunning, wants to sneak away from something, and the probability is that he will succeed-because actuality is not as sharp an examiner as anxiety-then anxiety is there at once ... If an individuality is not weaned away from shrewdness by himself, it will never be thoroughly accomplished, because finitude always explains in parts, never totally, and he whose shrewdness always fails (and even this is inconceivable in actuality) may seek the reason for this in his shrewdness and then strive to become still more shrewd.', 161, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', null, 'Anxiety as Saving Through Faith'); 

INSERT INTO excerpts(text, page_number, book_uid, chapter, section)
VALUES('From finitude one can learn much, but not how to be anxious, except in a very mediocre and depraved sense ... The hypochondriac is anxious about every insignificant thing, but when the significant appears he begins to breathe more easily. And why? Because the significant actuality is after all not so terrible as the possibility he himself had fashioned, and which he used his strength to fashion, whereas he can now use all his strength against actuality.', 162, 'fcebabd3-c23f-4564-bb61-8ddfd14065cb', null, 'Anxiety as Saving Through Faith'); 
